...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    watch: {
      ...
      files: ["build/less/*.less", "build/less/**/*.less", "dist/js/app.js", 'app/**/**/*.js','app/**/**/**/*.js', 'bower_components/*', "build/less-old/**"],
      tasks: ["less", "uglify", "concat", "wiredep"]
    },
    ...
    less: {
      ...
      development: {
        ...
        files: {
          "src/css/stylesheet.css": ["build/less/AdminLTE.less", "src/assets/iconmoon/style.css"],
    ...
    wiredep: {
      task: {
          // Point to all core js files from bower in your index.html
    ...
    usemin: {
          ...
          options: {
          assetsDirs: ['src', 'src/css', 'src/js', 'css', 'js']
        }
    },
    concat: {
        development: {
          ...
          files: {
            'src/js/app.js': ['app/app.js', 'app/*.js', 'app/**/*.js']
          }
        }
    }
  ...
  /** knowroaming grunt dependencies **/

  // Concatenate files
  grunt.loadNpmTasks('grunt-contrib-concat');
  // Bower plugin to place path in index.html
...
grunt.loadNpmTasks('grunt-bower-clean');
  ...
  grunt.registerTask('prod', ['wiredep']);
